...
For the second task, I have created 3 UML diagrams.
 ...
 4.METRICS
  ...
  For the Metrics, I have chosen Radon which is a very well known metrics and Bandit.
  
  For the first metrics, I have scanned the code with radon metrics which is calculates the complexity and maintainebility of a code.I have gotten a very good grade  of A(86.10). We know anything above the score of 75 is considered to be a code which is very easy to maintain - https://github.com/Ishitas400/ProjectASE/blob/main/radon.PNG  and https://github.com/Ishitas400/ProjectASE/blob/main/radon%20mi.jpg .
...
The output for (b);(c);(d) and (e) parts are found here - https://github.com/Ishitas400/ProjectASE/blob/main/op.PNG .
 ...
 I would like to acknowledge that I have used various websites like RealPython.com,Simplelearn.com,Stack-overflow.com,geeksforgeeks.org and also extentensively used wikipedia,GitHub  and Google in general for this project.I have also used materials taught by other Professors from the same department from our university.Last but not the definitely not the least, I would like to thank Prof. Edlich without whose support, I would not have been able to do the project and learn such an interesting subject.
